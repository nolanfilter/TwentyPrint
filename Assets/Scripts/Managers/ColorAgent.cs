...
public class ColorAgent : MonoBehaviour {
	...
	void Awake()
	{
        ...
        colorPacks[ (int)ColorPackType.Beige ] = new ColorPack( new Color( 0.3f, 0.29f, 0.26f ), new Color( 0.85f, 0.83f, 0.73f ) );
        colorPacks[ (int)ColorPackType.Monochrome ] = new ColorPack( Color.black, Color.white );
        colorPacks[ (int)ColorPackType.Rainbow ] = new ColorPack( RainbowColor, Color.black );
        colorPacks[ (int)ColorPackType.Sprinkles ] = new ColorPack( RandomColor, new Color( 0.06f, 0.1f, 0.14f ) );
